...
namespace offsets
{
	...
	extern DWORD m_fRoundStartTime;
	extern DWORD m_fWarmupPeriodEnd;
	...
	extern DWORD m_iCompetitiveRankType;
	...
	void UpdateOffsets();
	DWORD ParseOffset(const std::string& line);
}
