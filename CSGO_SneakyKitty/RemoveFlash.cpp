...
void RemoveFlash::operator()(int update_period_ms)
{
    while (true)
    {
        if (game::connection_state != client::kFullyConnected || game::feature_toggle[game::remove_flash_hotkey] == 0)
        {
        ...
        memory::WriteMem(module::csgo_process_handle, game::player_entity_address_list[game::local_player_index].address_ + offsets::m_flFlashDuration, 0.0f);
